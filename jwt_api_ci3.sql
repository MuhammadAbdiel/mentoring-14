...
INSERT INTO
    `categories` (`id`, `name`)
VALUES (2, 'Fashion'), (3, 'Tes'), (4, 'Food'), (6, 'Sport');
...
VALUES (
        ...
        'newUser1',
        'user1@example.com',
        '$2y$10$/qXVWI/5gtWnwrtdGkZ5uu5WHjaeJompAtrPAMt9kIFGZzie/4E26',
        '/default.jpg'
    ),
...
ALTER TABLE `products`
ADD
    CONSTRAINT `products_FK` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON UPDATE CASCADE;
